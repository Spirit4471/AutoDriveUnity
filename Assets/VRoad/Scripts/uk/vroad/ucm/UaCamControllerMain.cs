...
namespace uk.vroad.ucm
{
    ...
    public abstract class UaCamControllerMain : MonoBehaviour, LAppState, LAppInput
    {
        ...
        private bool readyToTrack = true;
        ...
        protected virtual void Update()
        {
            ...
            if (!readyToTrack)
            {
                ...
                float zoomX = -0.5f;
                cameraHeight = Math.Min(cameraHeight - zMult * zoomX, maxH);
              
                if (cameraHeight > maxH - 10)
                {
                    readyToTrack = true;
                    goToMapCentre = true;
            ...
            if (goToMapCentre)
            {
                ...
                Vector3 cameraUp = new Vector3(0, cameraHeightSeeWholeModel, -1);
        ...
        public virtual bool ReadyToTrack() { return readyToTrack;  }
        ...
        public bool IsAutoTracking()
        {
            ...
            if (autoTrack && !autoWasOn) readyToTrack = true;
            return autoTrack;
        }
